 ...
 * @author gabri
 */
public class FrameREMOVENDO extends javax.swing.JFrame {
    ...
    public FrameREMOVENDO() {
        initComponents();
        setLocationRelativeTo(null);
        setLayout(null);
        jPanel1.setLayout(null);
        subirBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));
        descerBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameREMOVENDO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameREMOVENDO().setVisible(true);
            }
        });
    }
